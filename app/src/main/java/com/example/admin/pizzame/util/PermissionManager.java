...
public class PermissionManager
{
    ...
    public PermissionManager(Context context, IPermissionManager listener) {
    ...
    public void checkResult(int requestCode,
                            String permissions[], int[] grantResults) throws IOException {
    ...
    public interface IPermissionManager{
        ...
        void onPermissionResult(boolean isGranted) throws IOException;
